...
public class MainConvertToCSV_XP2 {

	static final String inputDir = "./logs/exp2";
	static final String outputFilename = "exp2";
	...
	static final int formatVersion = 3;
	...
	public static void main(String[] args) {
		...
		csv = new CSVAggLogWriter_XP2(data, null, parsingOptions);
